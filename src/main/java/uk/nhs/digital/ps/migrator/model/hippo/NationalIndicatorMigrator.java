...
public class NationalIndicatorMigrator {
    ...
    private static final String PUBLISHEDDATE_COLUMN = "Published Date";    
    ...
    private static final String DESCRIPTOR_COLUMN = "Descriptor";    
    ...
    public List<NationalIndicatorHippoImportableItem> readIndicators(){
        ...
        while (rowIterator.hasNext()) {
            ...
            indicators.add(new NationalIndicator(null,
                ...
                this.xlsxReader.getDateValue(PUBLISHEDDATE_COLUMN,row),
                ...
                this.xlsxReader.getCellValue(DESCRIPTOR_COLUMN,row),
